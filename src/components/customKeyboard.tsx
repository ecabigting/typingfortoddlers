...
const CustomKeyboard = React.forwardRef<HTMLDivElement, CustomKeyboardProps>(
  ({ onKeyPress }, ref) => {
    // Define key layouts
    ...
    return (
      ...
      <div
        ref={ref}
        className="fixed bottom-0 left-0 right-0 bg-slate-100 dark:bg-slate-800 p-2 sm:p-3 shadow-lg z-50"
      >
